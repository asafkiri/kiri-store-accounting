...
9. `DOCUMENT_RETENTION_DAYS` הוא אופציונלי וברירת המחדל היא 365: כל צילום נמחק אוטומטית מ־Firestore ומ־Storage שנה מיום העלאתו, בלי שחזור. אם צריך לשמור את הצילומים לתקופה ארוכה יותר — למשל 7 שנים לפי תקנות ניהול פנקסי חשבונות — הזן כאן מספר ימים גדול יותר (עד 3650) או `0` כדי לבטל את המחיקה האוטומטית לגמרי. האפליקציה מציגה את התקופה שהשרת מדווח, כך שהמסך מתעדכן מעצמו אחרי שינוי.
...
16. פתח את צילומי חשבונית הבדיקה, לחץ ״מחק צילום לגמרי״ ואשר. הצילום צריך להיעלם מהמסך, ולחיצה על ״פתח עמוד / קובץ״ לאותו קובץ לא אמורה להיות זמינה יותר. זו מחיקה אמיתית ללא שחזור, ולכן יש לבצע אותה על צילום בדיקה בלבד.
